    ...
    <div class="content-wrapper">
        <div id="slide-show">
            <div class="page-header">
                <page-header titleName="Slide Show" :isCreate="true"></page-header>
            </div>
            <div class="content">
                <el-alert
                    v-if="messagesuccess"
...
export default {
    ...
    data(){
        return{
            ...
            messagesuccess: '',
            messageerror: '',
            dataTextCreate: 'Buat Slide Show',
            dataTextUpdate: 'Edit Slide Show',
            confirmDescDelete: 'Anda yakin akan menghapus data Slide Show dari daftar?',
            confirmTitleDelete: 'Hapus Slide Show',
            textDataCreateSuccess: 'Data Slide Show Berhasil ditambahkan.',
            textDataUpdateSuccess: 'Data Slide Show Berhasil diupdate.',
    ...
    methods:{
        buildUrl(value){
            if(value == true){
                return this.$baseUrl + this.sectionApi + "?limit=" + this.limit + "&page=" + this.page + "&order=position&sort=ASC"
            }else{
            ...
            if(type == "post"){
                ...
                try{
                    ...
                    if(response.status == 200){
                        ...
                        this.forms.link = this.itemDataDetail.link
