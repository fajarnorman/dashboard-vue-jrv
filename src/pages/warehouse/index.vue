<template>
    <div class="content-wrapper">
        <div id="warehouse">
            <page-header titleName="Warehouse" :isCreate="true"></page-header>
            <div class="content">
                                ...
                                <div class="item-forms-details">
                                    <div class="forms-details">
                                        <el-row :gutter="20">
											...
											<el-col :span="12">
                                                <el-form-item label="Titik Pengambilan Kredit">
													<el-select v-model="forms.credit_pickup_point">
...
export default {
    ...
    data(){
        return{
            ...
            forms: {
				name: "",
				address: "",
				credit_pickup_point: 1
            },
            rules: {
                name: [ { required: true, message: "Inputan Harus diisi", trigger: "blur" } ],
            },
            dataTextCreate: "Buat Warehouse",
            dataTextUpdate: "Edit Warehouse",
            confirmDescDelete: "Anda yakin akan menghapus data Warehouse dari daftar?",
            confirmTitleDelete: "Hapus Warehouse",
            textDataCreateSuccess: "Data Warehouse Berhasil ditambahkan.",
            textDataUpdateSuccess: "Data Warehouse Berhasil diupdate.",
            textDataDeleteSuccess: "1 Items Berhasil dihapus.",
        }
    },
    created(){
        this.$FUNCTIONS.checkPermissions(this.$dataRole['.cms.warehouse.get'])
    },
    mounted(){
        this.getPost()
    ...
    methods:{
            ...
            if(type == "post"){
                ...
                try{
                    ...
                    if(response.status == 200){
						...
						this.forms.credit_pickup_point = this.itemDataDetail.credit_pickup_point
        ...
        handleCurrentChange(val) {
            if (val) {
                // if(this.$dataRole['.cms.warehouse.*.get']){
        ...
        closeModal(row) {
			...
			this.forms.name = ""
			this.forms.address = ""
			this.forms.credit_pickup_point = 1
        },
        limitChange(limit){
            this.limit = limit
            this.$FUNCTIONS.checkPaginations()
