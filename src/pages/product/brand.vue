<template>
    <div class="content-wrapper">
        <div id="product-brand">
            <page-header titleName="Produk Brand" :isCreate="true"></page-header>
            <div class="content">
...
export default {
    ...
    data(){
        return{
            ...
            dataTextCreate: "Buat Brand",
            dataTextUpdate: "Edit Brand",
            confirmDescDelete: "Anda yakin akan menghapus data Brand dari daftar?",
            confirmTitleDelete: "Hapus Brand",
            textDataCreateSuccess: "Data Brand Berhasil ditambahkan.",
            textDataUpdateSuccess: "Data Brand Berhasil diupdate.",
    ...
    methods:{
        ...
        handleCurrentChange(val) {
            if (val) {
                if(this.$dataRole['.cms.brand.*.get']){
