<template>
    <div class="content-wrapper">
        <div id="product-tipe">
            <page-header titleName="Produk Tipe" :isCreate="true"></page-header>
            <div class="content">
                ...
                <el-table
					...
					<el-table-column label="Sort" width="50" align="center">
						<template slot-scope="scope">
							<a href="#" @click.prevent="" :dataId="scope.row.id" class="handle-sort">
                                ...
                                <div class="item-forms-details">
                                    <div class="forms-details">
                                        <el-row :gutter="20">
                                            ...
                                            <el-col :span="24">
                                                <el-form-item label="Icons" prop="files">
...
export default {
    ...
    data(){
        return{
            ...
            dataTextCreate: "Buat Tipe",
            dataTextUpdate: "Edit Tipe",
    ...
    created(){
        this.$FUNCTIONS.checkPermissions(this.$dataRole['.cms.type.get'])
    },
    mounted(){
        this.getPost()
        ...
        async getPost(){
            try{
                ...
                if(response.status == 200){
					...
					setTimeout(() => this.sortsItems(), 500)
                }else{
            ...
            if(type == "post"){
                ...
                try{
                    ...
                    if(response.status == 200){
                        ...
                        if(this.itemDataDetail.icon_url !== null){
		...
		updatePosition(id, newPosition){
			...
			.then(response => {
				if(response.data.status == 'error'){
					...
					this.messagesuccess = "Produk Tipe telah berhasil di ubah"
				}
			})
