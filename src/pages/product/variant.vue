<template>
    <div class="content-wrapper">
        <div id="product-variant">
            <page-header titleName="Produk Variant" :isCreate="true"></page-header>
            <div class="content">
...
export default {
    ...
    data(){
        return{
            ...
            dataTextCreate: "Buat Variant Produk",
            dataTextUpdate: "Edit Variant Produk",
            confirmDescDelete: "Anda yakin akan menghapus data Variant Produk dari daftar?",
            confirmTitleDelete: "Hapus Variant Produk",
            textDataCreateSuccess: "Data Variant Produk Berhasil ditambahkan.",
            textDataUpdateSuccess: "Data Variant Produk Berhasil diupdate.",
            textDataDeleteSuccess: "1 Items Berhasil dihapus.",
        }
    },
    created(){
        this.$FUNCTIONS.checkPermissions(this.$dataRole['.cms.variant.get'])
    },
    mounted(){
        this.getPost()
    ...
    methods:{
        ...
        handleCurrentChange(val) {
            if (val) {
                // if(this.$dataRole['.cms.variant.*.get']){
