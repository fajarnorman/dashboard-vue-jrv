<template>
    <div class="content-wrapper">
        <div id="supplier">
            <page-header titleName="Supplier" :isCreate="true"></page-header>
            <div class="content">
...
export default {
    ...
    data(){
        return{
            ...
            dataTextCreate: "Buat Supplier",
            dataTextUpdate: "Edit Supplier",
            confirmDescDelete: "Anda yakin akan menghapus data Supplier dari daftar?",
            confirmTitleDelete: "Hapus Supplier",
            textDataCreateSuccess: "Data Supplier Berhasil ditambahkan.",
            textDataUpdateSuccess: "Data Supplier Berhasil diupdate.",
            textDataDeleteSuccess: "1 Items Berhasil dihapus.",
        }
    },
    created(){
        this.$FUNCTIONS.checkPermissions(this.$dataRole['.cms.supplier.get'])
    },
    mounted(){
        this.getPost()
    ...
    methods:{
        ...
        handleCurrentChange(val) {
            if (val) {
                // if(this.$dataRole['.cms.supplier.*.get']){
