<template>
    <div class="content-wrapper">
        <div id="courier">
            <page-header titleName="Kurir" :isCreate="true"></page-header>
            <div class="content">
...
export default {
    ...
    data(){
        return{
            ...
            dataTextCreate: "Buat Kurir",
            dataTextUpdate: "Edit Kurir",
            confirmDescDelete: "Anda yakin akan menghapus data Kurir dari daftar?",
            confirmTitleDelete: "Hapus Kurir",
            textDataCreateSuccess: "Data Kurir Berhasil ditambahkan.",
            textDataUpdateSuccess: "Data Kurir Berhasil diupdate.",
