<template>
    <div class="content-wrapper">
        <div id="courier-rate">
            <page-header titleName="Kurir - Rate" :isCreate="true"></page-header>
            <div class="content">
                            ...
                            <el-form :model="forms" status-icon :rules="rules" ref="formsvalid" label-width="120px" class="demo-ruleForm">
                                <div class="item-forms-details">
                                    <div class="forms-details">
                                        <el-row :gutter="20">
                                            <el-col :span="12">
                                                <el-form-item label="Estimasi Pengiriman" prop="etd">
                                                    <el-input v-model="forms.etd"></el-input>
                                                </el-form-item>
                                            </el-col>
											<el-col :span="12">
                                                <el-form-item label="Nominal" prop="nominal">
                                                    <el-input v-model="forms.nominal"></el-input>
                                                </el-form-item>
                                            </el-col>
											<el-col :span="12">
                                                <el-form-item label="Kurir service" prop="courier_service_id">
													<el-select v-model="forms.courier_service_id">
														<el-option
											...
											<el-col :span="12">
                                                <el-form-item label="Provinsi" prop="province_id">
													<el-select v-model="forms.province_id">
														<el-option
...
export default {
    ...
    data(){
        return{
			sectionApi: "shipping/courierRate",
            ...
            dataTextUpdate: "Edit Kurir - Rate",
            ...
            textDataUpdateSuccess: "Data Kurir - Rate Berhasil diupdate.",
